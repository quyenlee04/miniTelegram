...
public class DieuKhienClient implements Initializable {
    ...
    private ThreadNhapXuatClient t;
    ...
    public void ketNoiMayChu() {
        t = new ThreadNhapXuatClient(serverName, port, labelBan, textAreaTrucTuyen, textAreaNoiDung, textFieldSoanThao, comboBoxChonNguoiNhan);
        t.start();
    }
